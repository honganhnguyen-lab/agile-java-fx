    ...
    private void initializeUserStories() {
        UserStory a =
                UserStoryFactory.getInstance()
                        .createNewUserStory("predefinedUS1", "description1", 1.0,0, "new");
        a.doRegister();
        UserStoryStore.getInstance().addUserStory(a);

        UserStory b =
                UserStoryFactory.getInstance()
                        .createNewUserStory("predefinedUS2", "description2", 2.0,0, "new");
        b.doRegister();
        ...
        UserStory c =
                UserStoryFactory.getInstance()
                        ...
                        .createNewUserStory("predefinedUS3", "description3", 3.0,0, "new");
