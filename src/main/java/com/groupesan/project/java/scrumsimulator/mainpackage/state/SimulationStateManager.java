...
public class SimulationStateManager {
    ...
    private static final SimulationStateManager instance = new SimulationStateManager();
    private static final String JSON_FILE_PATH = "src/main/resources/simulation.JSON";


    public static SimulationStateManager getInstance() {
        return instance;
    }
     ...
     * @param durationOfSprint The duration of sprints in the simulation.
     */
    public static void saveNewSimulationDetails(
            String simId, String simName, String numberOfSprints, String durationOfSprint) {
        ...
        newSimulation.put("DurationOfSprint", durationOfSprint);
