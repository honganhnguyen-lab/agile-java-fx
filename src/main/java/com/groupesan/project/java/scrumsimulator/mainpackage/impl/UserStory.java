...
public class UserStory extends ScrumObject {
    ...
    private boolean assignedToSprint = false;
     ...
     */
    public UserStory(String name, double pointValue, Integer businessValue, String status) {
        this.name = name;
        this.description = "";
     ...
     * @param pointValue the point value for the story as a way of estimating required effort.
     */
    public UserStory(String name, String description, double pointValue, Integer businessValue, String status) {
        this.name = name;
    ...
    public String getStoryStatus() {return status;}

    public void setStoryStatus(String status) { this.status = status;}
