...
public class EditUserStoryForm extends JFrame implements BaseComponent {
    ...
    Integer[] businessValList = { 0, 1, 3, 7, 13, 23, 37, 59 };

    private UserStory userStory;

    private JTextField nameField = new JTextField();
    private JComboBox<Integer> businessValField = new JComboBox<>(businessValList);
    ...
    public void init() {
        ...
        nameField.setText(userStory.getName());
        descArea.setText(userStory.getDescription());
        ...
        JLabel businessValueLabel = new JLabel("Business Value:"); // Renamed the JLabel
        myJpanel.add(
                businessValueLabel,
                new CustomConstraints(
        ...
        submitButton.addActionListener(
                new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        Integer selectedBusinessValue = (Integer) businessValField
                                .getSelectedItem(); // Renamed the local variable
                        Double points = (Double) pointsCombo.getSelectedItem();

                        userStory.setName(name);
                        userStory.setDescription(description);
                        userStory.setPointValue(points);
                        userStory.setBusinessValue(selectedBusinessValue);
                        dispose();
                    }
                });
